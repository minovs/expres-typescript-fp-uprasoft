...
export const checkLogin = async (login: string): Promise<RowDataPacket[string]> => {
...
export const checkUserInTokenStore = async (user_id: string): Promise<RowDataPacket[string]> => {
...
export const checkTokenInStore = async (refreshToken: string): Promise<RowDataPacket[string]> => {
...
export const updateToken = async (user_id: string, refreshToken: string) => {
